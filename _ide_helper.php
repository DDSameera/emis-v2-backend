...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Services\JsonResponseHandlerService $instance */
                        return $instance->successResponse($message, $data, $code);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function errorResponse($message = null, $data = null, $code = 500)
        {
                        /** @var \App\Services\JsonResponseHandlerService $instance */
                        return $instance->errorResponse($message, $data, $code);
        }
...
namespace  { 
            ...
            class JsonResponseHandler extends \App\Facades\ResponseHandlerFacade {}
